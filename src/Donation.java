...
public class Donation {
    ...
    public String formatDateTime() {
        dateToLDT();
        return ldt.getMonthValue() + "-" + ldt.getDayOfMonth() + "-" + ldt.getYear() + " at " + ldt.getHour() + ":" + ldt.getMinute() + ":" + ldt.getSecond();
    }

    @Override
    public String toString() {
        return "Date donation was made: " + formatDateTime() + " Amount Donated: " + amountDonated + " ID of Donator: " + alumniId + " ID of Event: " + eventId;
    }
